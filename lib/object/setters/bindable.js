  ...
  module.exports = (function(_super) {
    ...
    */
    ...
    _Class.prototype.now = function() {
      ...
      this._now = true;
      _Class.__super__.now.call(this);
      return (_ref = this._bothWaysBinding) != null ? _ref.now() : void 0;
    };
    ...
    */
    ...
    _Class.prototype.bothWays = function() {
      ...
      this._bothWaysBinding = this.to.bind(this.property).to(function(value) {
      ...
      if (this._now) {
        return this._bothWaysBinding.now();
      }
    };
