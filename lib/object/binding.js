...
(function() {
  var BindableSetter, Binding, DeepPropertyWatcher, bindableSetter, hoist, utils,
  ...
  module.exports = Binding = (function() {
    ...
    */
    ...
    Binding.prototype._listen = function() {
      return this._listener = new DeepPropertyWatcher(this._from, this._property, this._trigger);
    };
